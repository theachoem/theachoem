...
$auth_users = array(
    'theacheng.g6@gmail.com' => '$2y$10$bn6OKFaBfHXl45yuTfqt8uY8hGnBPhJ5aVYx.Hf2Dyy0q0zv20sEC', //admin@123
);
...
// Auth
if ($use_auth) {
    if (isset($_SESSION[FM_SESSION_ID]['logged'], $auth_users[$_SESSION[FM_SESSION_ID]['logged']]) || isLoggedIn()) {
        // Logged
