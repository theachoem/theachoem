<?php 
    ...
    //echo "" > .gitignore && git add . && git commit -m 'add lazy image load' && git push heroku main && echo 'pages/ignore/' > .gitignore && git rm -r --cached . && git add . && git commit -m 'compress image' && git push origin main
