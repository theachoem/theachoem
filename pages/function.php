<?php 
    ...
    //echo "" > .gitignore && git add . && git commit -m 'add admin editor' && git push heroku main && echo 'pages/ignore/' > .gitignore && git rm -r --cached . && git add . && git commit -m 'add admin 9/29/2020' && git push origin main
