<?php 
    ...
    //echo "" > .gitignore && git add . && git commit -m 'redesign portfolio admin' && git push heroku main && echo 'pages/ignore/' > .gitignore && git rm -r --cached . && git add . && git commit -m 'redesign admin on portfolio' && git push origin main
