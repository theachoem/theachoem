<?php 
    ...
    //echo "" > .gitignore && git add . && git commit -m 'update testimonial' && git push heroku main && echo 'pages/ignore/' > .gitignore && git rm -r --cached . && git add . && git commit -m 'update btn sidebar' && git push origin main
