<?php 
    ...
    //echo "" > .gitignore && git add . && git commit -m 'update slick' && git push heroku main && echo 'pages/ignore/' > .gitignore && git rm -r --cached . && git add . && git commit -m 'remove absolute' && git push origin main
