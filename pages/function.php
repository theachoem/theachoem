<?php 
    ...
    //echo "" > .gitignore && git add . && git commit -m 'fixing bug' && git push heroku main && echo 'pages/ignore/' > .gitignore && git rm -r --cached . && git add . && git commit -m 'fixing bugs' && git push origin main
